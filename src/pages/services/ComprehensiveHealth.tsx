    ...
    <div>
        ...
        <div className="relative mt-5">
            ...
            <div className="flex justify-center my-8">
              <h4 className="text-white text-[45px] leading-[60px] md:text-[55px] font-semibold text-center max-w-[800px]">
              ...
              <div className="grid md:grid-cols-3 lg:px-14 px-3 gap-4">
                <div className="bg-[#171717] z-10 rounded-[13px] flex justify-center items-center h-[300px] p-1">
                  <div>
                    ...
                    <h5 className="text-white text-center mt-5 max-w-[250px] text-[20px]">
                    Symptom checkers and health chatbots for quick guidance.
                ...
                <div className="bg-[#171717] z-10 rounded-[13px] flex justify-center items-center h-[300px] p-1">
                  <div>
                    ...
                    <h5 className="text-white text-center mt-5 max-w-[250px] text-[20px]">
                    Lifestyle recommendations tailored to your unique health profile.
                ...
                <div className="bg-[#171717] z-10 rounded-[13px] flex justify-center items-center h-[300px] p-1">
                  <div>
                    ...
                    <h5 className="text-white text-center mt-5 max-w-[250px] text-[20px]">
                    Digital health records for seamless organization.
                    </h5>
                  </div>
                </div>
              </div>
